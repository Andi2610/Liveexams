...
public class MyQuestionPaperLoad extends AppCompatActivity implements ConnectivityReciever.ConnectivityReceiverListener,Handler.Callback{
...
// The substituted value will be contained in the result variable
    ...
    protected void onResume() {
        super.onResume();
        MyApplication.getInstance().setConnectivityListener(MyQuestionPaperLoad.this);
    }

    public void startNewActivity() {
        Intent intent = new Intent(MyQuestionPaperLoad.this, QuizMainActivity.class);
    ...
    public void downloadQP() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET,
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(MyQuestionPaperLoad.this, "Sorry! Couldn't connect to internet", Toast.LENGTH_SHORT).show();
                retryButtonForDownload.setVisibility(View.VISIBLE);
                exitButton.setVisibility(View.VISIBLE);
                avi.hide();
                progressBar.setVisibility(View.INVISIBLE);
