 ...
 */
public class AuthorFragmentForMyKits extends Fragment {
    ...
    public AuthorFragmentForMyKits() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_author_fragment_for_my_kits, container, false);
    }

    @Override
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        super.onActivityCreated(savedInstanceState);
        authorsList=(RecyclerView)getActivity().findViewById(R.id.authorsListForMyKits);
        ...
        authorInterface=(AuthorInterfaceForMyKits) getActivity();
                ...
                searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
                    ...
                    public boolean onQueryTextChange(String s) {
                        ...
                        if(s.equals("")){
                            ...
                            authorsListAdapter = new AuthorsListAdapterForMyKits(filteredList, getActivity(),authorInterface,response);
    ...
    public void setList(){
        list=new ArrayList<>();
        list=getArguments().getStringArrayList("list");
        authorsListAdapter = new AuthorsListAdapterForMyKits(list, getActivity(),authorInterface,response);
        authorsList.setLayoutManager(linearLayoutManager);
        authorsList.setItemAnimator(new DefaultItemAnimator());
        authorsList.setAdapter(authorsListAdapter);
        authorsListAdapter.notifyDataSetChanged();
...
interface AuthorInterfaceForMyKits{
